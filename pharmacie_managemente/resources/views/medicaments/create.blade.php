...
@section('content')
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">Ajouter un Médicament</h1>

        <form method="POST" action="{{ route('medicaments.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select name="categorie_id" class="w-full border rounded-lg px-3 py-2" required>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Forme/Dosage *</label>
                    <input type="text" name="forme_dosage" value="{{ old('forme_dosage') }}"
                        placeholder="Ex: Comprimé 500mg" class="w-full border rounded-lg px-3 py-2" required>
                </div>
            </div>
            ...
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-1">Date Expiration *</label>
